...
![Supported Node.js version: ^12.17.x || ^14.15.x || 15.x || 16.x || 17.x](https://img.shields.io/static/v1?label=node&message=%5E12.17.x%20%7C%7C%20%5E14.15.x%20%7C%7C%2015.x%20%7C%7C%2016.x%20%7C%7C%2017.x&color=brightgreen)
