...
function toIntAndBigintCases<TCase extends readonly [unknown, unknown]>(
...
function getBytesDataList(byteLength: number): BytesData[] {
...
const unshiftInspect = <TActual, TExpected>(
    cases: ReadonlyArray<readonly [TActual, TExpected]>,
