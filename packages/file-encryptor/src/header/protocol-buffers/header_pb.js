...
goog.exportSymbol('proto.Header.CryptAlgorithm', null, global);
...
proto.Header.toObject = function(includeInstance, msg) {
  var f, obj = {
    cryptAlgorithm: jspb.Message.getFieldWithDefault(msg, 1, 0),
    keySalt: msg.getKeySalt_asB64(),
    keyLength: jspb.Message.getFieldWithDefault(msg, 3, 0),
    argon2KeyOptions: (f = msg.getArgon2KeyOptions()) && proto.Argon2Options.toObject(includeInstance, f),
    cryptNonce: msg.getCryptNonce_asB64(),
    cryptAuthTag: msg.getCryptAuthTag_asB64(),
...
proto.Header.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.Header.CryptAlgorithm} */ (reader.readEnum());
      msg.setCryptAlgorithm(value);
      break;
    case 2:
    ...
    case 4:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.setCryptNonce(value);
      break;
    case 5:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.setCryptAuthTag(value);
      break;
    case 6:
...
proto.Header.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCryptAuthTag_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      5,
      f
...
/**
 * optional CryptAlgorithm crypt_algorithm = 1;
 * @return {!proto.Header.CryptAlgorithm}
 */
proto.Header.prototype.getCryptAlgorithm = function() {
  return /** @type {!proto.Header.CryptAlgorithm} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.Header.CryptAlgorithm} value
 * @return {!proto.Header} returns this
 */
proto.Header.prototype.setCryptAlgorithm = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional bytes key_salt = 2;
...
/**
 * optional bytes crypt_nonce = 4;
 * @return {!(string|Uint8Array)}
 */
proto.Header.prototype.getCryptNonce = function() {
...
/**
 * optional bytes crypt_nonce = 4;
 * This is a type-conversion wrapper around `getCryptNonce()`
 * @return {string}
 */
proto.Header.prototype.getCryptNonce_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getCryptNonce()));
};
 ...
 * @return {!Uint8Array}
 */
proto.Header.prototype.getCryptNonce_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getCryptNonce()));
};
 ...
 * @return {!proto.Header} returns this
 */
proto.Header.prototype.setCryptNonce = function(value) {
  return jspb.Message.setProto3BytesField(this, 4, value);
};


/**
 * optional bytes crypt_auth_tag = 5;
 * @return {!(string|Uint8Array)}
 */
proto.Header.prototype.getCryptAuthTag = function() {
...
/**
 * optional bytes crypt_auth_tag = 5;
 * This is a type-conversion wrapper around `getCryptAuthTag()`
 * @return {string}
 */
proto.Header.prototype.getCryptAuthTag_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getCryptAuthTag()));
};
 ...
 * @return {!Uint8Array}
 */
proto.Header.prototype.getCryptAuthTag_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getCryptAuthTag()));
};
 ...
 * @return {!proto.Header} returns this
 */
proto.Header.prototype.setCryptAuthTag = function(value) {
...
/**
 * optional bytes crypt_nonce = 1;
 * @return {!(string|Uint8Array)}
 */
proto.SimpleHeader.prototype.getCryptNonce = function() {
 ...
 * @return {string}
 */
proto.SimpleHeader.prototype.getCryptNonce_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getCryptNonce()));
};
 ...
 * @return {!Uint8Array}
 */
proto.SimpleHeader.prototype.getCryptNonce_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getCryptNonce()));
};
 ...
 */
proto.SimpleHeader.prototype.setCryptNonce = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};


/**
 * optional bytes crypt_auth_tag = 2;
 * @return {!(string|Uint8Array)}
 */
proto.SimpleHeader.prototype.getCryptAuthTag = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.SimpleHeader.prototype.getCryptAuthTag_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getCryptAuthTag()));
};
 ...
 * @return {!Uint8Array}
 */
proto.SimpleHeader.prototype.getCryptAuthTag_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getCryptAuthTag()));
};
 ...
 * @return {!proto.SimpleHeader} returns this
 */
proto.SimpleHeader.prototype.setCryptAuthTag = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
