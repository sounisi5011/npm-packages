 ...
 */
export function parsePackageJson(arg: {
    pkgJsonText: string;
    pkgJsonFilename: string;
}): z.infer<typeof packageJsonSchema> {
    const pkgJsonObject = parseJson(arg.pkgJsonText, arg.pkgJsonFilename);
    ...
    validationError.message += ` in '${arg.pkgJsonFilename}'`;
